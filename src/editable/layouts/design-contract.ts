...
export const editableRootStyle = {
  ...
  '--slot4-page-text': '#090a2b',
  '--slot4-panel-bg': '#eaf4ff',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#3f4960',
  '--slot4-soft-muted-text': '#687386',
  '--slot4-accent': '#00c853',
  '--slot4-accent-fill': '#00c853',
  '--slot4-accent-soft': '#e8f6ff',
  '--slot4-dark-bg': '#07072d',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#e7eef7',
  '--slot4-cream': '#f8fbff',
  '--slot4-warm': '#ffffff',
  '--slot4-lavender': '#e8f2ff',
  '--slot4-gray': '#f2f6fb',
  '--slot4-body-gradient': 'linear-gradient(180deg, #f8fbff 0%, #ffffff 44%, #eef6ff 100%)',
  '--editable-container': '1296px',
  '--editable-border': 'rgba(9, 10, 43, 0.12)',
} as CSSProperties

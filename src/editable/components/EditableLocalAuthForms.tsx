...
const inputClass = 'h-12 rounded-lg border border-[var(--editable-border)] bg-white px-4 text-base font-bold text-[#090a2b] outline-none transition placeholder:text-slate-400 focus:border-[#090a2b] focus:bg-white'
